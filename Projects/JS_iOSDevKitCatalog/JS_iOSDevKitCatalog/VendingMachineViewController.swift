...
class VendingMachineViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        textfieldUserMoney.delegate = self
    }
    ...
    @IBAction func buttonCar(_ sender: UIButton) {
        ...
        selectCarFree()
        textfieldUserMoney.placeholder = "구매 가능 금액을 적어주세요."
    }
    ...
    // MARK: textField Return 버튼으로 키보드 내리기
